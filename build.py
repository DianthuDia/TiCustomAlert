...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','tk.dmap.ti.customalert.js')
	...
	f = os.path.join(cwd,'Classes','TkDmapTiCustomalertModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','tk.dmap.ti.customalert.js']
